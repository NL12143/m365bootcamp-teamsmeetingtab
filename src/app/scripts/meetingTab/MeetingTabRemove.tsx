...
export interface IMeetingTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface IMeetingTabRemoveProps {

}

/**
 * Implementation of MeetingTab remove page
 */
export class MeetingTabRemove  extends TeamsBaseComponent<IMeetingTabRemoveProps, IMeetingTabRemoveState> {
